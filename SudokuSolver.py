...
class SudokuSolver(object):
    states = ['Ready', 'Sole_Candidates', 'Unique_Candidates', 'Done']
    ...
    def __init__(self, sp):
        ...
        machine.add_transition(trigger='perform_step', source='Unique_Candidates', dest='Done',
    ...
    def fill_sole_candidates(self):
        ...
        return self.print_state_and_return(filled_cells)

    def fill_unique_candidates(self):
        filled_cells = self.sudoku_puzzle.fill_unique_candidates()
        return self.print_state_and_return(filled_cells)

    def print_state_and_return(self, filled_cells):
        if filled_cells:
